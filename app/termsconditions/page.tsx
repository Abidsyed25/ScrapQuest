  ...
  return (
    <div className="relative">
      ...
      <div className="container mx-auto p-6 max-w-[48rem]">
        <h1 className="text-4xl font-bold mb-6 text-center">Terms and <span className="bg-[#8abf83] rounded px-2">Conditions</span></h1>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Introduction</h2>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Definitions</h2>
          <ul className="list-disc list-inside text-white-700 mb-6">
            <li><strong>&quot;Service&quot;</strong> refers to the web scraping services provided by ScrapQuest.</li>
            <li><strong>&quot;We,&quot; &quot;Us,&quot; &quot;Our&quot;</strong> refers to ScrapQuest.</li>
            <li><strong>&quot;You,&quot; &quot;Your&quot;</strong> refers to the user or customer of our website and services.</li>
          </ul>
        </section>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Use of Service</h2>
          ...
          <ul className="list-disc list-inside text-white-700 mb-6">
            ...
            <li>Use our services to scrape websites that you do not have permission to scrape.</li>
            <li>Interfere with or disrupt the integrity or performance of our services.</li>
          </ul>
        </section>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Intellectual Property</h2>
          <p className="mb-6 text-white-700">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Data Privacy</h2>
          <p className="mb-6 text-white-700">
            We value your privacy and are committed to protecting your personal information. Please review our <a href="#" className="text-blue-600">Privacy Policy</a> to understand how we collect, use, and protect your data.
          </p>
        </section>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Limitation of Liability</h2>
          <p className="mb-6 text-white-700">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Indemnification</h2>
          <p className="mb-6 text-white-700">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Modifications to the Service and Terms</h2>
          <p className="mb-6 text-white-700">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-center">Governing Law</h2>
          <p className="mb-6 text-white-700">
        ...
        <section className="mb-6">
          ...
          <p className="mb-6 text-white-700 text-center">
            Email: <a href="mailto:support@scrapquest.com" className="text-blue-600">support@scrapquest.com</a><br />
            Phone: <a href="tel:+123456789" className="text-blue-600">+1 234 567 89</a>
          </p>
        </section>
